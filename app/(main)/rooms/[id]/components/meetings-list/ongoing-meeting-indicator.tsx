  ...
  return (
    <div
      ...
      className={cn(
        ...
        isEndingSoon &&
          "border-amber-500/60 from-amber-500/20 via-amber-500/10 to-orange-500/20 shadow-amber-500/20"
      )}
    >
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-1 flex items-center gap-2">
              ...
              {isEndingSoon && (
                <Badge
                  variant="outline"
                  className="h-4 animate-pulse border-amber-500/50 px-1.5 py-0 text-[10px] text-amber-600"
                >
                  Ending soon
                </Badge>
              )}
            ...
            <div className="text-center">
              <div
                className={cn(
                  ...
                  isEndingSoon ? "text-amber-600" : "text-emerald-600"
                )}
              >
                Remaining
              </div>
